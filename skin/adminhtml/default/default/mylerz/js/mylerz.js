...
myObj={
	...
	defaultVal:function(){
		this.shipperCountry=$('mylerz_shipment_shipper_country').value;
		this.shipperCity=$('mylerz_shipment_shipper_city').value;
		this.shipperZip=$('mylerz_shipment_shipper_postal').value;
		this.shipperState=$('mylerz_shipment_shipper_state').value;
		
		this.recieverCountry=$('mylerz_shipment_receiver_country').value;
		this.recieverCity=$('mylerz_shipment_receiver_city').value;
		this.recieverZip=$('mylerz_shipment_receiver_postal').value;
		this.recieverState=$('mylerz_shipment_receiver_state').value;
	},
	cropValues:function(){
		this.defaultVal();	
	...
	openPickup:function(){
		...
		$('pickup_address').value=$('mylerz_shipment_shipper_street').value;
		$('pickup_company').value=$('mylerz_shipment_shipper_company').value;
		$('pickup_contact').value=$('mylerz_shipment_shipper_name').value;					
		$('pickup_email').value=$('mylerz_shipment_shipper_email').value;
